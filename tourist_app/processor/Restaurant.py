...
def find_restaurants(latitude, longitude, user_id, distance, price, rating):
    ...
    recommendations = get_recommendations(all_restaurants, latitude, longitude, distance, price, rating)
